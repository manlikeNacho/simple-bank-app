...
const account2 = {
  ...
  movementsDates: [
    ...
    '2022-05-09T18:49:59.371Z',
    '2022-05-11T12:01:20.894Z',
  ],
  currency: 'USD',
  locale: 'en-US',
};
...
const trueDate = function(date, locale){
...
btnTransfer.addEventListener('click', function (e) {
  ...
  const date = trueDate(Date.now(), currentAccount.locale);
